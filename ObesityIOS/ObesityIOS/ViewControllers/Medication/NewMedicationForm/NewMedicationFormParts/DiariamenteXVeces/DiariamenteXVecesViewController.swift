...
class DiariamenteXVecesViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let celda:ListItemDiariamenteXVecesViewCell = self.tvHora.dequeueReusableCell(withIdentifier: "celda") as! ListItemDiariamenteXVecesViewCell;
