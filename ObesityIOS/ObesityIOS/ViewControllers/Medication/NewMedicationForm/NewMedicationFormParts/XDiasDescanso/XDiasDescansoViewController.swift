//
//  XDiasDescansoViewController.swift
//  ObesityIOS
//
...
class XDiasDescansoViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let celda:ListItemXDiasDescansoViewCell = self.tvHora.dequeueReusableCell(withIdentifier: "celda") as! ListItemXDiasDescansoViewCell;
